...
public class EditProfileActivity extends AppCompatActivity {
    ...
    @Bind(R.id.change_name) EditText _nameText;
    @Bind(R.id.change_lastname) EditText _lastnameText;
    //@Bind(R.id.input_address) EditText _addressText;
    @Bind(R.id.change_email) EditText _emailText;
    @Bind(R.id.change_mobile) EditText _mobileText;
    @Bind(R.id.change_password) EditText _passwordText;
    @Bind(R.id.change_reEnterPassword) EditText _reEnterPasswordText;
